      ...
      <div className="w-full max-w-lg bg-card rounded-xl shadow-lg border overflow-hidden flex flex-col animate-in fade-in zoom-in-95 duration-200">
        ...
        <form action={handleSubmit} className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between px-4 py-3 border-b bg-background">
            ...
            <span className="font-semibold text-sm">Create Document</span>
            <Button 
              type="submit"
              variant="ghost" 
              size="sm" 
          ...
          <div className="p-6 space-y-6 bg-background">
             ...
             <div className="flex justify-center mb-6">
                <div className="w-24 h-32 bg-white shadow-md border rounded-lg flex flex-col items-center justify-center p-4 gap-2">
                   <span className="text-4xl font-serif text-pink-400 font-bold">A</span>
                   <div className="space-y-1 w-full">
                      <div className="h-1.5 w-full bg-pink-400 rounded-full"></div>
                      <div className="h-1.5 w-3/4 bg-pink-400 rounded-full"></div>
                      <div className="h-1.5 w-1/2 bg-pink-300 rounded-full"></div>
                   </div>
                   <div className="absolute bottom-2 right-2 border-l border-t w-6 h-6 border-gray-200 bg-gray-50 rounded-tl-lg"></div>
                </div>
             </div>
